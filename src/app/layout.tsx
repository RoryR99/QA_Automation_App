...
export function AppLayout() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-72 bg-gradient-to-b from-primary/20 via-accent/10 to-transparent" />
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        <header className="mb-8 flex flex-col gap-5 rounded-[2rem] border border-white/70 bg-white/78 p-5 shadow-ambient backdrop-blur md:flex-row md:items-center md:justify-between">
          <div className="space-y-3">
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              ...
              <div className="space-y-2">
                <Badge variant="success" className="w-fit bg-primary/10 text-primary">
            ...
            <div>
              <p className="max-w-2xl text-sm text-muted-foreground">
                Rebuilt as a local React app with mock services, query-driven data, and zero Microsoft runtime
                dependencies.
              </p>
            </div>
          </div>
          <div className="rounded-2xl border border-primary/10 bg-secondary/80 px-4 py-3 text-sm text-secondary-foreground">
            {currentRun ? (
